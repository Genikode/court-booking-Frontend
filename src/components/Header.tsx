      ...
      <nav className="flex justify-between items-center px-4 md:px-2 py-4">
        ...
        <div className="flex items-center gap-4">
            {/* <div className=" relative">
              <BsSearch className="text-red-700 absolute top-2 right-2" />
              <input placeholder="Search..." type="text"  className="border border-red-700 text-[#183d5a] rounded-full pl-8 pr-4 py-1 w-full focus:outline-none  placeholder-[#183d5a] " />
          </div>          */}
